...
sed -i 's|binary.prosite.pfscanv3.path=${bin.directory}/prosite/pfscanV3|binary.prosite.pfscanv3.path=${bin.directory}/prosite/altbin/pfscanV3.noaf|' ${PATH_TO_INTERPROSCAN_PROPERTIES}
sed -i 's|binary.prosite.pfsearchv3.path=${bin.directory}/prosite/pfsearchV3|binary.prosite.pfsearchv3.path=${bin.directory}/prosite/altbin/pfsearchV3.noaf|' ${PATH_TO_INTERPROSCAN_PROPERTIES}
